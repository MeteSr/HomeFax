...
`frontend/src/__tests__/contracts/candid.contract.test.ts` — verifies that frontend IDL factories stay in sync with Motoko canister types. Tests the auth, payment, job, and property services.
